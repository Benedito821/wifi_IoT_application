...
const int  WIFI_APP_CONNECTING_USING_SAVED_CREDS_BIT		= BIT0,
           WIFI_APP_CONNECTING_FROM_HTTP_SERVER_BIT			= BIT1,
           WIFI_APP_USER_REQUESTED_STA_DISCONNECT_BIT		= BIT2,
           WIFI_APP_STA_CONNECTED_GOT_IP_BIT				= BIT3;

//Queue handle used to manipulate the main queue of events
static QueueHandle_t wifi_app_queue_handle;
//netif objcts for the station and access point
...
static void wifi_app_event_handler(void *arg,esp_event_base_t event_base,int32_t event_id,void* event_data)
{
    if(event_base == WIFI_EVENT)
    {
        switch(event_id)
        {
            ...
            blue_led_light_wifi_disconnected();
            break;
...
/**
 * Initializes the WiFi application event handler and IP events
*/
...
static void wifi_app_soft_ap_config(void)
{
    ...
    ESP_ERROR_CHECK(esp_netif_dhcps_start(esp_netif_ap));             //start the AP DHCP server for connecting the mobile phone
    ...
    ESP_ERROR_CHECK(WIFI_STA_POWER_SAVE);                                      //power save set to NONE
}
            ...
            switch(msg.msgID)
            {
                ...
                case WIFI_APP_MSG_STA_DISCONNECTED:
                    ...
                    else
				    {
                        ...
                        // Adjust this case to my needs - maybe I want to keep trying to connect...
				    }
