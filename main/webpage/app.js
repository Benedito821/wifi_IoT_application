...
/**
 * Gets MPU6050 sensor temperature value for display on the web page.
 */
function getMPUSensorValues()
{
	$.getJSON('/mpuSensor.json', function(data) {
		$("#temperature_reading").text(data["temp"]);
	});
}

/**
 * Sets the interval for getting the updated MPU6050 sensor values.
 */
function startMPUSensorInterval()
{
	setInterval(getMPUSensorValues, 1000);    
}
